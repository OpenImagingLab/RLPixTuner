...
class NatureCNN(BaseFeaturesExtractor):
    ...
    def forward(self, observations: th.Tensor) -> th.Tensor:
        # self.cnt+=1
        # if observations.shape[0] > 20 and self.cnt > 1000:
        #     print(observations.shape)
        #     print("...")
        #     print("img", observations[0, 0:6])
        #     print("stop", observations[0, 6:7])
        #     print("step", observations[0, 7:8])
        #     print("step 1", observations[0, 7:8])
        #     print("step 2", observations[1, 7:8])
        #     print("step 3", observations[2, 7:8])
        #     print("step 4", observations[5, 7:8])
        #     print("step 5", observations[11, 7:8])
        #     print("para", observations[0, 8:11])
        #     print("spec", observations[0, 11:14])
        #     exit()
        # img, target, stop, step, params, lum, contrast, saturation
...
class HdrnetCNN(BaseFeaturesExtractor):
    def __init__(
            self,
            observation_space: gym.Space,
            features_dim: int = 512,
    ...
    def __init__(
        ...
        for key, subspace in observation_space.spaces.items():
            if is_image_space(subspace, normalized_image=normalized_image):
                ...
                elif cfg.use_hdrnet_cnn:
                    extractors[key] = HdrnetCNN(subspace, features_dim=cnn_output_dim, normalized_image=normalized_image)
                else:
